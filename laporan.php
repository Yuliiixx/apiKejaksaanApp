...
function tambahLaporan($id_user, $laporan_text, $laporan_pdf, $status, $tipe_laporan, $ktp) {
    global $conn;
    ...
    $sql = "INSERT INTO tb_laporan (id_user, laporan_text, laporan_pdf, status, tipe_laporan, ktp) VALUES ('$id_user', '$laporan_text', '$outputfile', '$status', '$tipe_laporan', '$ktpFile')";
...
function ubahLaporan($id, $laporan_text, $laporan_pdf, $status, $tipe_laporan, $ktp) {
    global $conn;
...
function hapusLaporan($id) {
    ...
    $sql = "SELECT laporan_pdf, ktp FROM tb_laporan WHERE id_laporan = ?";
...
switch ($request_method) {
    ...
    case 'POST':
        ...
        if (isset($_POST["id_laporan"])) {
            $id = $_POST["id_laporan"];
            if (ubahLaporan($id, $laporan_text, $laporan_pdf, $status, $tipe_laporan, $ktp)) {
            ...
            if (tambahLaporan($id_user, $laporan_text, $laporan_pdf, $status, $tipe_laporan, $ktp)) {
